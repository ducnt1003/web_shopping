    ...
    <table>
        ...
        @forelse($brands as $brand)
            <tr>
                ...
                <td>
                    @if($brand->photo)
                        <img  class="img-thumbnail" width="120px" src="{{asset($brand->photo)}}" alt="{{$brand->name}}"/>
                    @endif
                </td>
                <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a class="btn btn-primary" href="{{ route('admin.brands.edit',$brand->id) }}">
                            <i class="fas fa-edit"></i>
                        </a>
                        <button type="button" class="delete btn btn-danger" data="{{$brand->id}}">
            ...
            <div class="modal-content">
                <form action="{{route('admin.brands.delete')}}" method="post">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModalLabel">xóa brand!</h5>
